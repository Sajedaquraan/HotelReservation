...
namespace HotelReservation.Controllers
{
    public class BanksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Bankid,Bankname,Cardnumber,Expirydate,Cardholdername,Cvv")] Bank bank)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Bankid,Bankname,Cardnumber,Expirydate,Cardholdername,Cvv")] Bank bank)
        {
            if (id != bank.Bankid)
            {
                return NotFound();
